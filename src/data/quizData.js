...
const TRIADS_ONLY_CHAPTERS = [window.CHAPTERS.TRIADS];
...
window.learningPath = [
    ...
    { name: '10. Level 10: Full Random Practice', keys: Object.keys(window.quizData), mode: window.MODES.RANDOM_ALL, chapters: [window.CHAPTERS.ACCIDENTALS_COUNT, window.CHAPTERS.SCALE_SPELLING, window.CHAPTERS.TRIADS, window.CHAPTERS.SEVENTHS], requiredStreak: 10 },
